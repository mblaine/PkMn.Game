...
{
    public class Drip : Animation
    {
        protected static int spriteHeight = 288;

        public Drip(MonsterRenderer renderer, int delay, int param = 0, int startAt = 0, int stopEarly = int.MaxValue)
        ...
        {
            Texture2D sprite = SpriteManager.EffectSprites["drip"];
