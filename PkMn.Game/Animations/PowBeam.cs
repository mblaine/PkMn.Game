...
{
    public class PowBeam : Animation
    {
        ...
        public PowBeam(MonsterRenderer renderer, int delay, int param = 0, int startAt = 0, int stopEarly = int.MaxValue)
        ...
        public override void Draw(GameTime gameTime, GraphicsDevice device, SpriteBatch spriteBatch, int frameCounter)
        {
            ...
            int offset = renderer.ScreenEdgeDirection > 0 ? (animationFrame / 3) % 6 : (5 - (animationFrame / 3)) % 6;
