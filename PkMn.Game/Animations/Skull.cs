...
{
    public class Skull : Animation
    {
        public Skull(MonsterRenderer renderer, int delay, int param = 0, int startAt = 0, int stopEarly = int.MaxValue)
        ...
        {
            Texture2D sprite = SpriteManager.EffectSprites["skull"];
